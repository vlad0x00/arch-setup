...
transmission-qt tree xfce4-terminal shotwell noto-fonts-cjk noto-fonts-emoji noto-fonts-extra ttf-font-awesome neovim nautilus conky wget xfce4-screenshooter base-devel zsh zsh-completions \
